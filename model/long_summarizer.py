...
class Long_Summarizer(pl.LightningModule):
    def __init__(self, params):
        ...
        self.test_dataset = DoctorPatientDialogueDataset(self.params.val_file, is_train=False,is_split=self.params.is_split,max_input_length=self.params.max_input_length,max_output_length=self.params.max_output_length)
    ...
    def training_step(self, batch, batch_idx):
        ...
        # if (batch_idx + 1) % N == 0 or (batch_idx+1)==self.total_train_batches :
        #     opt.step()
        #     opt.zero_grad()
        #     sch.step()
    ...
    def test_dataloader(self):
        return torch.utils.data.DataLoader(self.test_dataset, batch_size=1, collate_fn=self.collate_fn_test,shuffle=False,num_workers=8)
